	...
	<div class="login-box">
		...
		<div class="card card-outline card-primary">
			<div class="card-header text-center">
				<a href="<?php echo base_url('login'); ?>" class="h1"><b><?php $settings->title ?? 'Login'; ?>
						<img style="margin: auto 5%;" src="<?php echo (!empty($logo) ? base_url($logo) : base_url("assets/images/logo.png")) ?>" alt="Logo"></b></a>
			</div>
			<div class="card-body">
				<!-- alert message -->
